...
| No       | Intrusion detection system (IDS)                                    |   The team should implemente an IDS. This can prevent data breaches, financial losses, and reputational damage.                                                                                                                                                                                                                     |
...
| -------- | --------------------------------------------------------------------------------------------------- | ------------ |
| No       | Only authorized users have access to customer's credit card information.                            |  All employees have access to it which is a bad practice in the business.            |
| No       | Credit card information is stored, accepted, processed, and transmitted, in a secure environment.   |    It is not encrypted and violates the law and regulations.        |
|          | Implement data encryption procedures to better secure credit card transaction touchpoints and data. |   It is not encrypted and violates the law and regulations.                    |
|  Yes        | Adopt secure password management policies.                                                          |              |

-General Data Protection Regulation (GDPR)

| Yes/No/? | Best Practice                                                                                                     | Explanations |
| -------- | ----------------------------------------------------------------------------------------------------------------- | ------------ |
| No       | E.U. customers’ data is kept private/secured.                                                                     |The organization does not apply GDPR practice. It puts them at risk of being fined by the EU government.   |
...
| No       | Enforce privacy policies, procedures, and processes to properly document and maintain data.                       |  It has been enforced by the IT Team members and other staff.          |
...
| No       | Data integrity ensures the data is consistent, complete, accurate, and has been validated. |        Data integrity is in place.      |
